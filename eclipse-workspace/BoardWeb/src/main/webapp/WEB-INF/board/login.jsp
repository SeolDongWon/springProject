...
<c:set var="deleteUserFlag" value="0" scope="request"></c:set>
...
<c:set var="updateUserFlag" value="0" scope="request"></c:set>
...
<c:set var="insertUserFlag" value="0" scope="request"></c:set>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
